...
public class InternshipService {
	...
	public boolean markInternshipCompleted(Long facultySupervisorId, Long internshipId) throws Exception {
		...
		InternshipEvaluateFormService internshipEvaluateFormService = new InternshipEvaluateFormService(internshipEvaluateFormRepository, internshipRepository,
				null, null, modelMapper, messageResource);
