...
public class InternshipRegistriesController {
	...
	@PostMapping("")
	public ResponseEntity<InternshipRegistries> addInternshipRegistries(@RequestBody InternshipRegistries internshipRegistries) {
		return ResponseEntity.ok(internshipRegistriesService.addInternshipRegistries(internshipRegistries));
	}
}
