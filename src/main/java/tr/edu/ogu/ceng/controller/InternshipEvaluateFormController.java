...
public class InternshipEvaluateFormController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<InternshipEvaluateForm> updateInternshipEvaluateForm(@PathVariable Long id,
			@RequestBody InternshipEvaluateForm internshipEvaluateForm) {
		InternshipEvaluateForm updatedForm = internshipEvaluateFormService.updateInternshipEvaluateForm(id, internshipEvaluateForm);
		return new ResponseEntity<>(updatedForm, HttpStatus.OK);
	}

	@DeleteMapping("/{id}")
	public ResponseEntity<Void> deleteInternshipEvaluateForm(@PathVariable Long id) {
		internshipEvaluateFormService.deleteInternshipEvaluateForm(id);
